...
<center>
    ...
    <div class="btn-group" role="group" aria-label="Basic example">
        <button class="btn btn-success" onclick="window.location.href='{{route('usos.create')}}'"> Crear uso
        </button>
    </div>
</center>
...
<table class="table table-bordered table-hover" id="tablaObjeto">
    ...
    <tr>
        ...
        <td>
            <form action="{{ route('usos.show',$uso->id) }}" method="get">
                @csrf
        ...
        <td>
            <center>
                <form action="{{ route('usos.edit',$uso->id) }}" method="get" style="display: inline-block">
                    @csrf
                ...
                <form action="{{ route('usos.destroy',$uso->id) }}" method="POST" style="display: inline-block;">
                    @csrf
                    @method('DELETE')
